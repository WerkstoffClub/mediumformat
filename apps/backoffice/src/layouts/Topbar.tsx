...
export function Topbar({ onOpenPalette }: { onOpenPalette: () => void }) {
  ...
  return (
    <header className="h-[60px] bg-[var(--bg-surface)] border-b border-[var(--border)] flex items-center px-5 gap-4 flex-shrink-0">
      <nav className="flex items-center gap-[7px] text-[12px] whitespace-nowrap" aria-label="Breadcrumb">
      ...
      <button
        ...
        className="flex items-center gap-[9px] bg-[var(--bg-overlay)] border border-[var(--border)] rounded-[8px] px-3 py-[9px] flex-1 max-w-[480px] mx-auto text-left transition-colors hover:border-[var(--text-muted)]"
      ...
      <div className="flex items-center gap-2.5 flex-shrink-0">
        ...
        <Link
          to="/inventory/new"
          className="flex items-center gap-1.5 px-3.5 py-[9px] rounded-[6px] bg-[var(--accent)] text-[var(--accent-text)] text-[13px] font-semibold hover:opacity-[.88] transition-opacity whitespace-nowrap"
        >
