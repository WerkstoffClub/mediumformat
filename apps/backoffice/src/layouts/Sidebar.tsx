...
const icons = {
  ...
  imports:    ic(<><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></>),
  consolidations: ic(<><path d="M21 8V6a2 2 0 00-2-2H5a2 2 0 00-2 2v2"/><path d="M3 8l9 6 9-6"/><path d="M3 8v10a2 2 0 002 2h14a2 2 0 002-2V8"/></>),
  ...
  pages:      ic(<><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></>),
  ...
  const groups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Imports',         to: '/imports',         icon: icons.imports },
        { label: 'Consolidations',  to: '/consolidations',  icon: icons.consolidations },
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Category pages', to: '/category-pages',  icon: icons.pages },
      ],
    },
    {
      label: 'Config',
